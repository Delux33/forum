...
***Задача проекта - получить опыт работы с Linux и написания простых bash скриптов, также углубить знания в Spring, Freemarker, Boostrap, Hibernate, Maven, PostgreSQL.***
____
